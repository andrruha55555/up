...
{
    option.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo { Version = "v1", Title = "GET" });
    option.SwaggerDoc("v2", new Microsoft.OpenApi.Models.OpenApiInfo { Version = "v2", Title = "POST" });
    option.SwaggerDoc("v3", new Microsoft.OpenApi.Models.OpenApiInfo { Version = "v3", Title = "PUT" });
    option.SwaggerDoc("v4", new Microsoft.OpenApi.Models.OpenApiInfo { Version = "v4", Title = "DELETE" });
});
